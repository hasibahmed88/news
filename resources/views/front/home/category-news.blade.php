    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 text-left">
          ...
          <h4>Category: {{ $category_name->category_name }}</h4>
          <div class="line"></div>
          <div class="row">
        ...
        <div class="col-md-4 sidebar">
          ...
          <aside>
            <h1 class="aside-title">Featured news</h1>
            <div class="aside-body">
            ...
            @foreach($featured_newses as $featured_news)
              <article class="article-mini">
                ...
                <div class="padding">
                  <h1><a href="{{ route('blog-details',['id'=>$featured_news->id]) }}">{{ Str::limit($featured_news->blog_title , 50, '...') }}</a></h1>
                  <div class="detail">
                    <div class="category"><a href="{{ route('category-news',['id'=>$featured_news->category_id]) }}">{{ $featured_news->category_name }}</a></div>
                    <div class="time">{{ date('M-d-y',strToTime($featured_news->created_at)) }}</div>
                  </div>
                </div>
                </div>
              </article>
