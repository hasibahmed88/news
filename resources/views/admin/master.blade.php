            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Website logo:</h6>
                        <a class="collapse-item" href="{{ route('manage-logo') }}">Manage Logo</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="Message" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('manage-message') }}">Manage Blog</a>
                    </div>
                </div>
            </li>
